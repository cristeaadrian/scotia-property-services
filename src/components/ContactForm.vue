<template>
  <section class="relative bg-white" aria-labelledby="contact-heading">
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <svg
        class="absolute top-0 right-0 z-0 translate-x-1/2 -translate-y-16 transform sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72"
        width="404"
        height="384"
        fill="none"
        viewBox="0 0 404 384"
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="relative bg-white shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3">
          <!-- Contact information -->
          <div
            class="relative overflow-hidden bg-gradient-to-b from-teal-500 to-teal-600 px-6 py-10 sm:px-10 xl:p-12"
          >
              ...
              <div>
                <div class="flex justify-between">
                  <label
                    ...
                    >Phone</label
                  >
                  <span id="phone-optional" class="text-sm text-stone-500"
                    >Optional</span
                  >
                </div>
                <div class="mt-1">
